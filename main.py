...
class VideoDownloader:
    ...
    def create_gui_after_click(self) -> None:
        self.video_title = Label(
            self.window,
            text=self.yt.title
            if len(self.yt.title) < 65
            else self.yt.title[:65] + "...",
        ...
        self.resolution_combo.place(x=360, y=110, width=120, height=30)
        self.caption_combo.place(x=490, y=110, width=120, height=30)
        self.format_combo.place(x=620, y=110, width=120, height=30)
    ...
    def configure_combos(self):
        ...
        self.video_format = resolutions[0]
